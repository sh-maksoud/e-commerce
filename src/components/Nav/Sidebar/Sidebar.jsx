...
//     closeSidebar(); // Close the sidebar before navigating
//   };
...
//           </div>
//           <div className="cart-actions">
//             <Link to="/cart" className="btn-go-cart" onClick={closeSidebar}>
//               Go to Cart
//             </Link>
//             <Link to="/shop" className="btn-shop" onClick={handleBackToShop}>
//               Back to Shop
...
const Sidebar = () => {
  const { isSidebarOpen, closeSidebar, cart, removeFromCart } = useStore();
  const [closeTimeout, setCloseTimeout] = useState(null);
  const sidebarRef = useRef(null); // Add ref to sidebar
